...
* @ return {string} containing the modified input
*/                
function punct(input, chars) {
    var output = "";
    var addedBoolCheck = false;
    if (chars == undefined) {
        var chars = [[" ampersand ", "&"], [" backslash ", "\\"], [" caret ", "^"], [" colon ",":"], [" commaa ",","], [" dollar ", "$"], [" dot ","."], [" equals ","="], [" greater than ", ">"], [" less than ", "<"], [" exclamation ", "!"], [" hash ", "#"], [" left bracket ","["], [" left brace ","{"], [" left parenthesis ","("],  [" minus ","-"],  [" modulo ","%"], [" new line ", "\n" ], [" right parenthesis ",")"], [" slash ","/"],  [" plus ","+"], [" question mark ","?"], [" quotes ",'"'], [" quote ","'"], [" right brace ","}"], [" right bracket ","]"], [" semicolon ",";"], [" tilde ", "~"], [" tab ", "	"], [" times ", "*"], [" underscore ", "_"]];
    }
...
* gets the code from code area called "yourcode", and
        ...
        (Sk.TurtleGraphics || (Sk.TurtleGraphics = {})).target = 'mycanvas';
         ...
         myPromise.then(function(mod) {
             ...
             function(err) {
                 ...
                 setCursorPosition(document.getElementById('yourcode'), lineNum);
              });
         }; 
}
...
function overview() {
	    ...
	    txtArea = document.getElementById('yourcode');
...
function sayItUsingPromise(data, lineNumber) {
    return new Promise(function(resolve, reject) {
       ...
       meSpeak.speak(newData, {}, function() {
          setCursorPosition(document.getElementById('yourcode'), lineNumber);
          resolve();
       });
    });
}
...
/**
* @method preload - not used currently
*/ 
function preload(){
...
* @param {Object} txtArea, the argument is the object to position the cursor
